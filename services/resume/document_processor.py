...
class DocumentProcessor:
      ...
      async def _normalize_with_llm(self, raw_text: str, file_type: str):
            ...
            system_message = """You are an expert resume parser and data extraction specialist. Your task is to extract and normalize resume information from raw text that may contain formatting issues or OCR errors.
                            ...
                            8. If information is unclear or missing, leave fields empty rather than guessing
            ...
            Requirements:
            - Fix formatting and OCR errors where obvious
            - Extract contact info (name, email, phone, location, social profiles)
            - Structure work experience with consistent date formats
            - Identify and categorize all skills mentioned
            - Extract education details including institutions and degrees
            - Capture certifications and other relevant sections
            - Preserve numerical achievements and metrics exactly as stated
